const elementos=document.querySelectorAll('[data-anima]'); //const= variável, elementos é a variavel, doc.querySelectorAll= seleciona as strings onde haverao alterações
